        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="banner-inner text-center text-lg-left">
                    <p class="subtitle">{{__($general->banner_header)}}</p>
                    <h2>{{__($general->banner_body)}}</h2>
                    <p>{{__($general->banner_footer)}}</p>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="footer-widget widget widget_nav_menu">
                        ...
                        <ul>
                            @foreach($frontMenu as $data)
                            <li><a href="{{route('single.page',['class' => 'Menu', 'id' =>$data->id])}}"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>{{__($data->title)}}</a></li>
                            @endforeach
                        </ul>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 text-center text-lg-right">
                    <p class="copyright">{{__($general->copyright_text)}}</p>
                </div>
            </div>
        </div>
    </div>
