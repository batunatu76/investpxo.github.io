        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
                <ul class="nav side-menu">
                    ...
                    <li><a href="{{route('ico_settings.index')}}"><i class="fa fa-btc"></i> @lang('ICO') </a></li>
                    ...
                    <li><a href="{{route('google_tools.index')}}"><i class="fa fa-google"></i> @lang('Google Tools') </a></li>
                    ...
                    <li><a><i class="fa fa-cog"></i> @lang('General') <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            ...
                            <li><a href="{{route('admin.gnl.template')}}">@lang('Template Settings')</a></li>
                            <li><a href="{{route('language-manage')}}">@lang('Language Manager')</a></li>
                        </ul>
                    </li>
