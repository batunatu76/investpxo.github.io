                                            ...
                                            <form method="post" action="{{route('update.gateway')}}"
                                                ...
                                                @if($gateway->id==5)
                                                    <div class="form-group">
                                                        ...
                                                        <p class="text-success"><small>Copy this link & save on your paystack portal (API Keys & Webhooks)</small></p>
                                                    </div>
                                                    <div class="form-group">
                                                        <strong>@lang('PAYSTACK PUBLIC KEY')</strong>
                                                        <input type="text" value="{{$gateway->gateway_key_one}}" class="form-control" id="gateway_key_one" name="gateway_key_one" >
                                                    </div>
                                                ...
                                                @if($gateway->id==6)
                                                <div class="form-group">
                                                    <strong>@lang('FLW PUBLIC KEY')</strong>
                                                    <input type="text" value="{{$gateway->gateway_key_one}}" class="form-control" id="gateway_key_one" name="gateway_key_one" >
                                                </div>
