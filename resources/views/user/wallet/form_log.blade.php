...
@section('title',__('My Wallets Transaction Log'))
@section('content')
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{($data->to_user_wallet->address)}}</td>
                                            ...
                                            <td>
                                                @if($data->status == 0)
                                                <button class="btn btn-success btn-sm" data-id="{{$data->id}}" data-bs-toggle="modal" data-bs-target="#acceptModal{{$data->id}}" data-toggle="tooltip" title="{{_('Accept')}}"> <i class="fa fa-check"></i></button>
                                                <button class="btn btn-danger btn-sm" data-id="{{$data->id}}" id="edit" data-bs-toggle="modal" data-bs-target="#cancelModal{{$data->id}}" data-toggle="tooltip" title="{{_('Cancel')}}"> <i class="fa fa-times"></i></button>
                                                @endif
                                            </td>
                                        </tr>
